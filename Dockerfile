...
RUN apt-get update && apt-get install -y \
	...
	unzip -q "/tmp/activiti-${ACTIVITI_VERSION}/wars/activiti-app.war" -d "${CATALINA_HOME}/webapps/activiti-app" && \
	...
	cp "/tmp/mysql-connector-java-${MYSQL_CONNECTOR_JAVA_VERSION}/mysql-connector-java-${MYSQL_CONNECTOR_JAVA_VERSION}-bin.jar" "${CATALINA_HOME}/webapps/activiti-app/WEB-INF/lib/" && \
